...
import {datetimeToTime, secsToTimeWithText} from "../../../../utils/timeFormatters";
  ...
  return (
    <div className={styles.train}>
      <div className={styles.left}>
        ...
        <div className={styles.info}>
          ...
          <span className={styles['departure-city']}>
            ...
            <img src={smallArrow} className={styles['departure-arrow']} alt='иконка-стрелка'/>
          </span>
      ...
      <div className={styles.middle}>
        <div className={styles.info}>
          <span className={styles.time}>{datetimeToTime(train?.from?.datetime)}
          </span>
        ...
        <div className={styles.info}>
          <span className={styles.time}>{datetimeToTime(train?.to?.datetime)}
          </span>
          <span className={styles.city}>{train?.to?.city?.name}</span>
          <span className={styles.station}>{train?.to?.railway_station_name} вокзал</span>
        </div>
      </div>
