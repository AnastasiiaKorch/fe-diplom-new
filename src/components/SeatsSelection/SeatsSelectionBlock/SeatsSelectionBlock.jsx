...
import styles from './SeatsSelectionBlock.module.scss';

function SeatsSelectionBlock({direction}){
  const navigate = useNavigate();
  const seats = useSelector(selectSelectedSeats)[direction];
  const img = direction === directions.departure ? departureArrow : arrivalArrow;
...
SeatsSelectionBlock.propTypes = {
  direction: PropTypes.string.isRequired,
};

export default SeatsSelectionBlock;