...
import { addPersonalData, selectPersonalData} from "../../store/slices/personalDataSlice";
      ...
      >
        ...
        <div className={styles.section}>
          <div className={styles.row}>
            <Form.Item className="paymentOption"
                       name={fieldNames.lastName}
                       label={fieldNames.lastNameLabel}
                       rules={rules.lastName}
                       onChange={onChangeFullName}>
              <Input className={`${styles.inputField} ${styles.fullName} passengerCard-input`}
              allowClear
              />
            </Form.Item>
            <Form.Item className="paymentOption"
        ...
        <Form.Item name={fieldNames.paymentMethod}
                   rules={rules.paymentMethod}>
          <Radio.Group className={styles.radioGroup}>
            <div className={styles.section}>
              <Radio className={`${styles.radioRow} radioRow`}
